...
#        SCM_CO2_intensity=0.06*22.7*np.random.lognormal(m1, sd1, number_of_samples)  
    ...
    if (CCU_betters_Baseline<(number_of_samples/2)):
        flag = flag+1
...
plt.savefig(CCU_Concrete_Constants.output_file_name_histogram, format=CCU_Concrete_Constants.output_file_format)
